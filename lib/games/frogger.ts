...
export const FROGGER_SKINS: Record<SkinId, FroggerPalette> = {
  ...
  clasico: {
    ...
    camionCabina: "#7d8695",
    rueda: "#101018",
    // Madera clara: un tronco oscuro se perdía sobre el azul del río (1.9:1).
    tronco: "#c88b4a",
    troncoVeta: "#6b3f18",
    // Tortugas en verde azulado: separa su tono del verde de la rana.
    tortuga: "#25c2a8",
    tortugaEscama: "#0a6b5c",
    tortugaSumergida: "rgba(37, 194, 168, 0.42)",
    rana: "#2fe83f",
    ranaPata: "#1f9e2c",
    ranaOjo: "#ffffff",
    hudTexto: "#e8f4ff",
  ...
  neon: {
    ...
    metaBorde: "#f5ff00",
    metaOcupada: "#ff2fd6",
    // El magenta queda reservado a la rana: ningún coche lo usa.
    coches: ["#ff6a3d", "#f5ff00", "#00f0ff", "#b06bff"],
    camion: "#c9a7ff",
    camionCabina: "#9d7bff",
    rueda: "#1a0b2e",
    tronco: "#b98cf0",
    ...
    tortugaSumergida: "rgba(0, 240, 255, 0.32)",
    rana: "#ff2fd6",
    ranaPata: "#8f3dff",
    ranaOjo: "#f5ff00",
    hudTexto: "#e6f7ff",
  ...
  retro: {
    ...
    tronco: "#d69a45",
    troncoVeta: "#7a4f18",
    // Tortugas en ámbar-oliva: el verde fósforo queda solo para la rana.
    tortuga: "#c8d400",
    tortugaEscama: "#6b7300",
    tortugaSumergida: "rgba(200, 212, 0, 0.32)",
    rana: "#8aff8a",
    ranaPata: "#2fae2f",
    ranaOjo: "#5c3400",
    hudTexto: "#ffd88a",
